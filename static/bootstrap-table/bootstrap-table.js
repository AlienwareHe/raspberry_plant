...
(function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        this.$container.off('click', '.th-inner').on('click', '.th-inner', function (event) {
            ...
            if (that.options.detailView && !$this.parent().hasClass('bs-checkbox')) {
                if ($this.closest('.s-table')[0] !== that.$container[0]) {
                    return false;
                }
            }
        ...
        if (!this.options.showHeader || this.options.cardView) {
            ...
            this.getCaret();
            $(window).on('resize.s-table', $.proxy(this.resetWidth, this));
        }
    ...
    BootstrapTable.prototype.toggleFullscreen = function () {
        this.$el.closest('.s-table').toggleClass('fullscreen');
    };
    ...
    $.fn.bootstrapTable = function (option) {
        ...
        this.each(function () {
            ...
            if (typeof option === 'string') {
                ...
                if (option === 'destroy') {
                    $this.removeData('s.table');
                }
            }

            if (!data) {
                $this.data('s.table', (data = new BootstrapTable(this, options)));
            }
        });
